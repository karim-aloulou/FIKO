...
class InfoPage:
    ...
    def __init__(self, root):
        ...
        # root
        self.root = root
        self.root.title("FIKO")
        self.root.geometry("800x420+100+50")
        self.root.resizable(False, False)  # disable resizing

        # background image
        background = PhotoImage(file="Data_alert/Plan1.png")
        Label(self.root, image=background).place(x=350, y=0)
        ...
        logo_image = ImageTk.PhotoImage(Image.open("Data_alert/fiko.png"))  # create an ImageTk object
        ...
        Label(info_page, text="Driver name", font=("Goudy pld style", 12, "bold"), fg="#1D71B8", bg="white").place(x=30, y=150)
        ...
        Label(info_page, text="Contact name", font=("Goudy pld style", 12, "bold"), fg="#1D71B8", bg="white").place(x=30, y=210)
        ...
        Label(info_page, text="Contact email", font=("Goudy pld style", 12, "bold"), fg="#1D71B8", bg="white").place(x=30, y=270)
    ...
    def start_function(self):
        ...
        # otherwise, show a success message, close the window and start driving
            ...
            self.username,  self.contact_name,  self.contact_email = self.txt_driver_name.get(), self.txt_name_contact.get(), self.txt_email_contact.get()  # these will be deleted when the root is destroyed
