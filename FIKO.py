...
csv_file_path = 'crafted_data\plot_data.csv'
...
with open(csv_file_path, 'a', newline='') as csvfile:
    ...
    if not file_exists:
        csv_writer.writerow(['Opened Programs','Frame Number', 'Eye Aspect Ratio', 'Mouth Aspect Ratio', 'Head Tilt Degree', 'Eye Pupil'])
        Opened_Programs=1
    else:
    ...
    while True:
        ...
        if len(rects) > 0:
            ...
            for (i, (x, y)) in enumerate(shape):
                ...
                eye_pupil_value=gaze.horizontal_ratio()
            ...
            cv2.line(frame, start_point, end_point_alt, (0, 0, 255), 2)
                ...
                #modification du ration du tilt 
            if head_tilt_degree > 180:
                head_tilt_degree -= 360
            
            #head_tilt_degree = head_tilt_degree * 25 / 18
            #normalisation 0 1
            head_tilt_degree = (head_tilt_degree + 180) / 360
            if head_tilt_degree:
            ...
            csv_writer.writerow([Opened_Programs,frame_count, ear, mar, head_tilt_degree[0], eye_pupil_value])
            frame_count += 1
